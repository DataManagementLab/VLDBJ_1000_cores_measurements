...
colorbar,
colorbar style={ytick={2,4,6,8,10,12},yticklabels={2,4,6,8,10,12},ylabel={Speedup}},
colormap={mymap}{[1pt]
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=19, ymin=24, ymax=0] {speedup_heatmap-123.png};
...
\draw ({$(current bounding box.south west)!0.5!(current bounding box.south east)$}|-{$(current bounding box.south west)!0.98!(current bounding box.north west)$}) node[
  ...
  text=white!15!black,
  rotate=0.0
]{scaling_4wh: Speedup over individual X-min - Intel, Power9, Power8};
