...
colorbar,
colorbar style={ytick={50,100,150,200,250,300},yticklabels={50,100,150,200,250,300},ylabel={Thousand txn/s}},
colormap={mymap}{[1pt]
...
ytick={0.5,3.5,6.5,9.5,12.5,15.5,18.5,21.5},
yticklabels={DL DETECT,WAIT DIE,NO WAIT,MVCC,OCC,HSTORE,SILO,TICTOC}
]
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=19, ymin=24, ymax=0] {throughput_per_core_heatmap-005.png};
\path [draw=white, thick]
(axis cs:1,0)
--(axis cs:1,1);
...
\draw ({$(current bounding box.south west)!0.5!(current bounding box.south east)$}|-{$(current bounding box.south west)!0.98!(current bounding box.north west)$}) node[
  ...
  text=white!15!black,
  rotate=0.0
]{scaling_4wh: Throughput per Core - Intel, Power9, Power8};
