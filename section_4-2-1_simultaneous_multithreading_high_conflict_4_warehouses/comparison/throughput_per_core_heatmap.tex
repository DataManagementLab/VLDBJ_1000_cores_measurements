...
height=\figH,
major tick length=0,
point meta max=241.482413333658,
point meta min=2.88295530300803,
...
xticklabels={11,12,22,24,44,48,88,96},
y dir=reverse,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=8, ymin=16, ymax=0] {throughput_per_core_heatmap-000.png};
\path [draw=white]
(axis cs:0,2)
--(axis cs:8,2);
...
\draw ({$(current bounding box.south west)!0.5!(current bounding box.south east)$}|-{$(current bounding box.south west)!0.98!(current bounding box.north west)$}) node[
  ...
  text=white!15!black,
  rotate=0.0
]{smt_4WH: Throughput per Core - Power9, Power8};
