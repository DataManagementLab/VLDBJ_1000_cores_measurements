...
title={all-txn-scaling-4WH-comp-power8: Throughput per Core - All Txn, NewOrder \& Payment},
width=\figW,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=10, ymin=16, ymax=0] {combined-all-txn-scaling-4WH-comp-power8-throughput-per-core-heatmap-001.png};
\path [draw=white]
(axis cs:0,2)
--(axis cs:10,2);
