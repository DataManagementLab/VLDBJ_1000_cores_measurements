...
colorbar horizontal,
colorbar style={xtick={0.1,1},xticklabels={\(\displaystyle {10^{-1}}\),\(\displaystyle {10^{0}}\)}},
colormap={mymap}{[1pt]
...
title={ Throughput - 1. Intel - All Txn, 2. Power9 - All Txn, 3. Power8 - All Txn},
width=\figW,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=19, ymin=24, ymax=0] {combined-all-txn-scaling-4WH-comp-throughput-heatmap-005.png};
\path [draw=white]
(axis cs:0,3)
--(axis cs:19,3);
