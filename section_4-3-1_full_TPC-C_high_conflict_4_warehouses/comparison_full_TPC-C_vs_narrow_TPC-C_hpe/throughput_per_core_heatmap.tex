...
height=\figH,
major tick length=0,
point meta max=272.397226465967,
point meta min=0.738216556379215,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=9, ymin=16, ymax=0] {throughput_per_core_heatmap-000.png};
\path [draw=white]
(axis cs:0,2)
--(axis cs:9,2);
...
\draw ({$(current bounding box.south west)!0.5!(current bounding box.south east)$}|-{$(current bounding box.south west)!0.98!(current bounding box.north west)$}) node[
  ...
  text=white!15!black,
  rotate=0.0
]{Throughput per Core - NewOrder + Payment, All Txn};
