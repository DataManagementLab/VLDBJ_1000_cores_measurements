...
colorbar,
colorbar style={ytick={2,4,6,8,10,12,14,16,18},yticklabels={2,4,6,8,10,12,14,16,18},ylabel={Speedup}},
colormap={mymap}{[1pt]
...
height=\figH,
major tick length=0,
point meta max=18.8386758511725,
point meta min=0.918966464591742,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=9, ymin=16, ymax=0] {speedup_heatmap-012.png};
\path [draw=white]
(axis cs:0,2)
--(axis cs:9,2);
...
\draw ({$(current bounding box.south west)!0.5!(current bounding box.south east)$}|-{$(current bounding box.south west)!0.98!(current bounding box.north west)$}) node[
  ...
  text=white!15!black,
  rotate=0.0
]{Speedup over individual X-min - NewOrder + Payment, All Txn};
