...
colorbar,
colorbar style={ytick={1,10},yticklabels={\(\displaystyle {10^{0}}\),\(\displaystyle {10^{1}}\)},ylabel={Speedup}},
colormap={mymap}{[1pt]
...
height=\figH,
major tick length=0,
point meta max=17.2738773286318,
point meta min=0.994785442799315,
...
xticklabels={24,48,96,192,464,928,1504},
y dir=reverse,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=7, ymin=16, ymax=0] {speedup_heatmap-000.png};
\path [draw=white]
(axis cs:0,2)
--(axis cs:7,2);
...
\draw ({$(current bounding box.south west)!0.5!(current bounding box.south east)$}|-{$(current bounding box.south west)!0.98!(current bounding box.north west)$}) node[
  ...
  text=white!15!black,
  rotate=0.0
]{scaling_1568WH_comp_power9_investigation: Speedup over individual X-min - NewOrder & Payment - Orig, NewOrder & Payment - Replicated};
