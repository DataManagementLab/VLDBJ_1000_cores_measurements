...
colorbar,
colorbar style={ytick={100},yticklabels={\(\displaystyle {10^{2}}\)},ylabel={Thousand txn/s}},
colormap={mymap}{[1pt]
...
height=\figH,
major tick length=0,
point meta max=233.046213060237,
point meta min=22.9015825655507,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=7, ymin=16, ymax=0] {throughput_per_core_heatmap-000.png};
\path [draw=white]
(axis cs:0,2)
--(axis cs:7,2);
...
\draw ({$(current bounding box.south west)!0.5!(current bounding box.south east)$}|-{$(current bounding box.south west)!0.98!(current bounding box.north west)$}) node[
  ...
  text=white!15!black,
  rotate=0.0
]{scaling_1568WH_comp_power9_investigation: Throughput per Core - NewOrder & Payment - Orig, NewOrder & Payment - Replicated};
