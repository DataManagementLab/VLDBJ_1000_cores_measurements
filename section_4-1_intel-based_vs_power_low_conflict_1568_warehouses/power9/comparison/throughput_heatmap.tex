...
height=\figH,
major tick length=0,
point meta max=83.6623837697121,
point meta min=3.40920124551065,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=7, ymin=16, ymax=0] {throughput_heatmap-000.png};
\path [draw=white]
(axis cs:0,2)
--(axis cs:7,2);
...
\draw ({$(current bounding box.south west)!0.5!(current bounding box.south east)$}|-{$(current bounding box.south west)!0.98!(current bounding box.north west)$}) node[
  ...
  text=white!15!black,
  rotate=0.0
]{scaling_1568WH_comp_power9_investigation: Throughput - NewOrder & Payment - Orig, NewOrder & Payment - Replicated};
