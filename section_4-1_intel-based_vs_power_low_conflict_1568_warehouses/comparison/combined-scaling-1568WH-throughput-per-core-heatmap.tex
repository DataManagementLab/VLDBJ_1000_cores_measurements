...
title={ Throughput per Core - 1. Intel, 2. Power9, 3. Power8},
width=\figW,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=23, ymin=24, ymax=0] {combined-scaling-1568WH-throughput-per-core-heatmap-003.png};
\path [draw=white]
(axis cs:0,3)
--(axis cs:23,3);
