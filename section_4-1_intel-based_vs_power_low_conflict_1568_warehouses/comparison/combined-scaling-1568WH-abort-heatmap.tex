...
colorbar horizontal,
colorbar style={xtick={0,0.05,0.1,0.15,0.2,0.25,0.3},xticklabels={0.00,0.05,0.10,0.15,0.20,0.25,0.30}},
colormap={mymap}{[1pt]
...
title={ Abort Ratio (Aborted Txn/Total Txn) - 1. Intel, 2. Power9, 3. Power8},
width=\figW,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=23, ymin=24, ymax=0] {combined-scaling-1568WH-abort-heatmap-000.png};
\path [draw=white]
(axis cs:0,3)
--(axis cs:23,3);
