...
title={ Throughput per Core - 1. Intel - Remote, 2. Power9 - Remote, 3. Power8 - Remote},
width=\figW,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=6, ymin=24, ymax=0] {combined-remote-comp-throughput-per-core-heatmap-002.png};
\path [draw=white]
(axis cs:0,3)
--(axis cs:6,3);
