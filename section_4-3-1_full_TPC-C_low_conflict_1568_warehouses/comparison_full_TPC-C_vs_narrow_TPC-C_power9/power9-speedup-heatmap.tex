...
title={ Speedup over individual X-min - 1. All Txn, 2. All Txn (Replicated Internals)},
width=\figW,
...
ytick={0.5,1.5,2.5,3.5,4.5,5.5,6.5,7.5,8.5,9.5,10.5,11.5,12.5,13.5,14.5,15.5},
yticklabels={
  DL DETECT 1.,
  2.,
  WAIT DIE 1.,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=11, ymin=16, ymax=0] {combined-all-txn-scaling-1568WH-comp-power9-speedup-heatmap-005.png};
\path [draw=white]
(axis cs:0,2)
--(axis cs:11,2);
