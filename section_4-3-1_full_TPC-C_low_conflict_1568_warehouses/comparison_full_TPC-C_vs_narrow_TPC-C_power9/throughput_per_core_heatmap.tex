...
colorbar,
colorbar style={ylabel={Thousand txn/s}},
colormap={mymap}{[1pt]
...
height=\figH,
major tick length=0,
point meta max=219.551579840374,
point meta min=10.3802974199862,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=10, ymin=16, ymax=0] {throughput_per_core_heatmap-000.png};
...
\draw ({$(current bounding box.south west)!0.5!(current bounding box.south east)$}|-{$(current bounding box.south west)!0.98!(current bounding box.north west)$}) node[
  ...
  text=white!15!black,
  rotate=0.0
]{all_txn_scaling_1568WH_comp_power9: Throughput per Core - NewOrder & Payment, All Txn};
