...
height=\figH,
major tick length=0,
point meta max=81.1016103813424,
point meta min=4.58294664439904,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=10, ymin=16, ymax=0] {throughput_heatmap-000.png};
...
\draw ({$(current bounding box.south west)!0.5!(current bounding box.south east)$}|-{$(current bounding box.south west)!0.98!(current bounding box.north west)$}) node[
  ...
  text=white!15!black,
  rotate=0.0
]{all_txn_scaling_1568WH_comp_power9: Throughput - NewOrder & Payment, All Txn};
