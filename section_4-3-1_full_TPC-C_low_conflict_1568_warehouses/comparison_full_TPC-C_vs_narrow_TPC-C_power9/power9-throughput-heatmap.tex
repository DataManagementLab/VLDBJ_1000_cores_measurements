...
title={ Throughput - 1. All Txn, 2. All Txn (Replicated Internals)},
width=\figW,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=11, ymin=16, ymax=0] {combined-all-txn-scaling-1568WH-comp-power9-throughput-heatmap-003.png};
\path [draw=white]
(axis cs:0,2)
--(axis cs:11,2);
