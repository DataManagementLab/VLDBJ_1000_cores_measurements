...
colorbar,
colorbar style={ytick={0,0.025,0.05,0.075,0.1,0.125,0.15,0.175},yticklabels={0.000,0.025,0.050,0.075,0.100,0.125,0.150,0.175},ylabel={Abort Ratio (%)}},
colormap={mymap}{[1pt]
...
height=\figH,
major tick length=0,
point meta max=0.199832205445316,
point meta min=0,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=10, ymin=16, ymax=0] {abort_heatmap-000.png};
...
\draw ({$(current bounding box.south west)!0.5!(current bounding box.south east)$}|-{$(current bounding box.south west)!0.98!(current bounding box.north west)$}) node[
  ...
  text=white!15!black,
  rotate=0.0
]{all_txn_scaling_1568WH_comp_power9: Abort Ratio (Aborted Txn/Total Txn) - NewOrder & Payment, All Txn};
