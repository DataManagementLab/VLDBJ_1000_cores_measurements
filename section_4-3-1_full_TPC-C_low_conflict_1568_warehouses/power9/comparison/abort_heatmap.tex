...
height=\figH,
major tick length=0,
point meta max=0.223133855586837,
point meta min=0,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=10, ymin=16, ymax=0] {abort_heatmap-001.png};
...
\draw ({$(current bounding box.south west)!0.5!(current bounding box.south east)$}|-{$(current bounding box.south west)!0.98!(current bounding box.north west)$}) node[
  ...
  text=white!15!black,
  rotate=0.0
]{all_txn_scaling_1568WH_comp_power9_investigation: Abort Ratio (Aborted Txn/Total Txn) - With Placement, Replicated Internals};
