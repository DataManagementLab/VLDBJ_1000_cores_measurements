...
colorbar,
colorbar style={ytick={10},yticklabels={\(\displaystyle {10^{1}}\)},ylabel={Million txn/s}},
colormap={mymap}{[1pt]
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=10, ymin=16, ymax=0] {throughput_heatmap-008.png};
...
\draw ({$(current bounding box.south west)!0.5!(current bounding box.south east)$}|-{$(current bounding box.south west)!0.98!(current bounding box.north west)$}) node[
  ...
  text=white!15!black,
  rotate=0.0
]{all_txn_scaling_1568WH_comp_power9_investigation: Throughput - All - Orig, All - Replicated Internals};
