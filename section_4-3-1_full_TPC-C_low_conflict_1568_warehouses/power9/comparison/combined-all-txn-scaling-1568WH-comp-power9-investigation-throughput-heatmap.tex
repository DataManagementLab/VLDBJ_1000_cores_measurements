...
height=\figH,
major tick length=0,
point meta max=44.946346624131,
point meta min=1.78488659718469,
scaled y ticks={base 10:-3},
tick align=outside,
title style={yshift=-1.5ex},
title={all-txn-scaling-1568WH-comp-power9-investigation: Throughput - All - Orig, All - Replicated Internals},
width=\figW,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=10, ymin=16, ymax=0] {combined-all-txn-scaling-1568WH-comp-power9-investigation-throughput-heatmap-000.png};
\path [draw=white]
(axis cs:0,2)
--(axis cs:10,2);
