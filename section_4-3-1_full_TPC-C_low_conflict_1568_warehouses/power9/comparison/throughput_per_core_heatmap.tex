...
colorbar,
colorbar style={ytick={100},yticklabels={\(\displaystyle {10^{2}}\)},minor ytick={20,30,40,50,60,70,80,90},minor yticklabels={
...
height=\figH,
major tick length=0,
point meta max=101.599776459047,
point meta min=10.5308548053099,
...
xticklabels={24,48,96,192,384,464,752,928,1120,1504},
y dir=reverse,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=10, ymin=16, ymax=0] {throughput_per_core_heatmap-005.png};
...
\draw ({$(current bounding box.south west)!0.5!(current bounding box.south east)$}|-{$(current bounding box.south west)!0.98!(current bounding box.north west)$}) node[
  ...
  text=white!15!black,
  rotate=0.0
]{all_txn_scaling_1568WH_comp_power9_investigation: Throughput per Core - All - Orig, All - Replicated Internals};
