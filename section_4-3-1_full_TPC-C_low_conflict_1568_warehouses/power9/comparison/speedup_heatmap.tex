...
height=\figH,
major tick length=0,
point meta max=24.6876251384292,
point meta min=0.999778388621639,
...
ytick={0.5,2.5,4.5,6.5},
yticklabel style={rotate=90.0},
yticklabels={DL DETECT,NO WAIT,OCC,SILO}
]
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=10, ymin=8, ymax=0] {speedup_heatmap-001.png};
...
\draw ({$(current bounding box.south west)!0.5!(current bounding box.south east)$}|-{$(current bounding box.south west)!0.98!(current bounding box.north west)$}) node[
  ...
  text=white!15!black,
  rotate=0.0
]{all_txn_scaling_1568WH_comp_power9_investigation: Speedup over individual X-min - All - Orig, All - Replicated Internals};
