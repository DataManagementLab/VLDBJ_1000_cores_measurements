...
title={all-txn-scaling-1568WH-comp-power9-investigation: Abort Ratio (Aborted Txn/Total Txn) - All - Orig, All - Replicated Internals},
width=\figW,
...
ytick={0.5,2.5,4.5,6.5,8.5,10.5,12.5,14.5},
yticklabels={DL DETECT,WAIT DIE,NO WAIT,MVCC,OCC,HSTORE,SILO,TICTOC}
]
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=11, ymin=16, ymax=0] {combined-all-txn-scaling-1568WH-comp-power9-investigation-abort-heatmap-000.png};
\path [draw=white]
(axis cs:0,2)
--(axis cs:11,2);
