...
title={all-txn-scaling-1568WH-comp-power9-investigation: Throughput per Core - All - Orig, All - Replicated Internals},
width=\figW,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=11, ymin=16, ymax=0] {combined-all-txn-scaling-1568WH-comp-power9-investigation-throughput-per-core-heatmap-000.png};
\path [draw=white]
(axis cs:0,2)
--(axis cs:11,2);
